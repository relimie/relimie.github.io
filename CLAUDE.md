...
- **To add an article**: (1) create `assets/docs/articles/[slug]_[lang].md` (all 3 langs), (2) add an entry to the `articles` array, (3) add its 3 URLs + the hub lastmod to `sitemap-main.xml`, (4) `node build_html.js`.
